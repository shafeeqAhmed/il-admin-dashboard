...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <?php $active_class = ['completed', 'confirmed']; ?>
    <?php $in_active_class = ['cancelled', 'pending']; ?>
                    ...
                    <td>
                        ...
                        <table style="width: 90%; margin: 0 auto; background-color: #ffffff; padding-top: 20px; padding-left: 20px; padding-bottom: 20px; padding-right: 20px;" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td style="width: 100%; float: left; text-align: left; font-size: 25px; color: #606060; text-transform: capitalize; font-weight: 700;">Hi {{!empty($data['freelancer']['first_name'])?$data['freelancer']['first_name']:"Freelancer"}}!</td>
                                @endif
                            </tr>

                            <tr>
                                <td style="width: 100%; float: left; text-align: left; font-size: 16px; color: #999999; font-weight: 600; margin-top: 10px; margin-bottom: 10px;">You have a {{$data['status']}} {{($data['email_type']) ?? "class"}}:</td>
                            </tr>
                            ...
                            <tr>            
                                <td style="width: 100%; float: left; margin-top: 25px; margin-bottom: 10px; text-align: center;">
                                    ...
                                    <a href="#" style="background-color: #43DCBB;color: #ffffff;font-size: 16px;text-align: center;float: left;border-radius: 37px;text-decoration: none;padding-top: 9px;padding-bottom: 9px;padding-left: 25px;padding-right: 25px;">
                                        <img src="http://d2bp2kgc0vgu09.cloudfront.net/uploads/general/6035180209cd31614092290.png" style="border: none; float: left; width: 21px; margin-right: 5px; margin-top: 3px;"><span style="float: left; margin-top: 2px;">{{ucwords($data['status'])}}</span>
                                    </a>
                                    @elseif(!empty($data['status']) && $data['status'] == "pending")
                                    <a href="#" style="background-color: #EC625E;color: #ffffff;font-size: 16px;text-align: center;float: left;border-radius: 37px;text-decoration: none;padding-top: 9px;padding-bottom: 9px;padding-left: 25px;padding-right: 25px;">
                                        <img src="http://d2bp2kgc0vgu09.cloudfront.net/uploads/general/5ffdd1e827c421610469864.png" style="border: none; float: left; width: 21px; margin-right: 5px; margin-top: 3px;"><span style="float: left; margin-top: 2px;">{{ucwords($data['status'])}}</span>
                                    </a>
                                    @else
                                    <a href="#" style="background-color: #43DCBB;color: #ffffff;font-size: 16px;text-align: center;float: left;border-radius: 37px;text-decoration: none;padding-top: 9px;padding-bottom: 9px;padding-left: 25px;padding-right: 25px;">
                                        <img src="http://d2bp2kgc0vgu09.cloudfront.net/uploads/general/5ffdd1e827c421610469864.png" style="border: none; float: left; width: 21px; margin-right: 5px; margin-top: 3px;"><span style="float: left; margin-top: 2px;">{{ucwords($data['status'])}}</span>
                                ...
                                <td>
                                    <table style="width: 90%; margin: 0 auto; background-color: #F9F9F9; border-radius: 10px; padding-top: 30px; padding-left: 20px; padding-bottom: 20px; padding-right: 20px;" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <!-- User Image -->
                                            @if($data['send_to']=="customer")
                                            <!-- Show Freelancer Image -->
                                            @if(!empty($data['freelancer']['profile_image']))
                                            <td style="max-width: 54px; float: left;"><img style="object-fit: cover; max-width: 54px; border-radius: 100px; width:54px; height: 54px" src="<?= "http://d2bp2kgc0vgu09.cloudfront.net/uploads/profile_images/freelancers/96/" . $data['freelancer']['profile_image']; ?>" /></td>
                                            @endif                                            
                                            @elseif($data['send_to']=="freelancer")
                                            <!-- Show Class Images -->
                                            @if(!empty($data['class_data']['image']))
                                            <td style="max-width: 54px;float: left;"><img style="object-fit: cover; max-width: 54px; border-radius: 100px; width:54px; height: 54px" src="<?= "http://d2bp2kgc0vgu09.cloudfront.net/uploads/classes/" . $data['class_data']['image']; ?>" /></td>
                                            @endif
                                            @endif
                                            ...
                                            <td style="width: 60%; float: left; padding-left: 10px; padding-top: 3px;">
                                                <table style="width: 100%; float: left;">
                                                    <tbody>
                                                        @if($data['send_to']=="customer")
                                                        <tr><td style="width: 100%; float: left; text-align: left; font-size: 20px; color: #606060; text-transform: capitalize; line-height: 13px; font-weight: 700;">{{!empty($data['freelancer']['first_name']) ? $data['freelancer']['first_name']:"Freelancer"}} {{!empty($data['freelancer']['last_name']) ? $data['freelancer']['last_name']:null}}</td></tr>
                                                        <tr><td style="width: 100%; float: left; text-align: left; font-size: 16px; color: #999999; font-weight: 600; text-transform: capitalize;">{{!empty($data['freelancer']['profession'])? $data['freelancer']['profession'] : "Freelancer"}}</td></tr>
                                                        @elseif($data['send_to']=="freelancer")
                                                        <!-- Show Class Name -->
                                                        <tr><td style="width: 100%; float: left; text-align: left; font-size: 20px; color: #606060; text-transform: capitalize; line-height: 13px; font-weight: 700;">{{!empty($data['class_data']['name'])?$data['class_data']['name']:"No Name"}}</td></tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 60%; float: left; margin-top: 20px; font-size: 20px; color: #606060; text-align: left; font-weight: 600;">{{$data['class_data']['name']}}</td>
                                        </tr>
                                        @endif
                                        ...
                                        <tr>
                                            ...
                                            if (!empty($data['class_data']['online_link'])) {
                                                $type = "Online";
                                                $image = "602e71253a0191613656357.png";
                                            }
                                            ?>
                                        ...
                                        @if(!empty($data['class_data']['address']))
                                        <tr>
                                            ...
                                            <td style="width: 60%; float: left; margin-top: 20px; font-size: 13px; color: #606060; text-align: left; font-weight: 600;"><img src="http://d2bp2kgc0vgu09.cloudfront.net/uploads/general/5ffdd3463ce141610470214.png" style="width: 12px;" /> {{ $data['class_data']['address']}}</td>
                                        </tr>
                                        @elseif(!empty($data['class_data']['online_link']))
                                        <tr >
                                            <td style="width: 100px; float: left; margin-top: 20px; font-size: 13px; color: #606060; text-align: left; font-weight: 600; text-transform: capitalize;">Location:</td>
                                            <td style="width: 60%; float: left; margin-top: 20px; font-size: 13px; color: #606060; text-align: left; font-weight: 600;"><img src="http://d2bp2kgc0vgu09.cloudfront.net/uploads/general/{{$image}}" style="width: 12px;" /> {{ $data['class_data']['online_link']}}</td>
                                        </tr>
                                        @endif

                                        @if($data['send_to'] == "freelancer")
                                        @if(($data['class_data']['students_booked'] > 0) && $data['class_data']['students_booked'] < $data['class_data']['no_of_students'])
                                        <tr>
                                            <td style="width: 100px; float: left; margin-top: 20px; font-size: 13px; color: #606060; text-align: left; font-weight: 600; text-transform: capitalize;">Members:</td>
                                            <td style="width: 60%; float: left; margin-top: 20px; font-size: 13px; color: #606060; text-align: left; font-weight: 600;">{{$data['class_data']['students_booked']}}/{{$data['class_data']['no_of_students']}} slots</td>
                                        </tr>
                                        @endif
                                        @endif
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 100%; float: left; margin-top: 25px; margin-bottom: 10px; text-align: center;">
                                        ...
                                        @elseif(!empty($data['status']) && $data['status'] == "pending")                                        
                                        <a href="#" style="background-color: #EC625E;color: #ffffff;font-size: 18px;text-align: center;display: inline-block;border-radius: 37px;text-decoration: none;padding-top: 10px;padding-bottom: 10px;padding-left: 45px;padding-right: 45px;margin: auto;">
                                            <img src="http://d2bp2kgc0vgu09.cloudfront.net/uploads/general/5ffdd1e827c421610469864.png" style="border: none; float: left; width: 21px; margin-right: 5px; margin-top: 3px;"><span style="float: left; margin-top: 2px;">{{ucwords($data['status'])}}</span>
                                        </a>
                                        @else
                                        <a href="#" style="background-color: #43DCBB;color: #ffffff;font-size: 16px;text-align: center;float: left;border-radius: 37px;text-decoration: none;padding-top: 9px;padding-bottom: 9px;padding-left: 25px;padding-right: 25px;">
