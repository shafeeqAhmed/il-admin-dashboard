...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    $data['appointment_data']['send_to']="customer"
    ?>
                    ...
                    <td>
                        ...
                        <table style="width: 90%; margin: 0 auto; background-color: #ffffff; padding-top: 20px; padding-left: 20px; padding-bottom: 20px; padding-right: 20px;" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td style="width: 100%; float: left; text-align: left; font-size: 25px; color: #606060; text-transform: capitalize; font-weight: 700;">Hi {{!empty($data['appointment_data']['appointment_customer']['user']['first_name'])?$data['appointment_data']['appointment_customer']['user']['first_name']:"Customer"}}!</td>
                                @elseif($data['appointment_data']['send_to']=="freelancer")
                                <td style="width: 100%; float: left; text-align: left; font-size: 25px; color: #606060; text-transform: capitalize; font-weight: 700;">Hi {{!empty($data['appointment_data']['appointment_freelancer']['user']['first_name'])?$data['appointment_data']['appointment_freelancer']['user']['first_name']:"Freelancer"}}!</td>
                                @endif
                            </tr>
                            ...
                            <tr>
                                <td style="width: 100%; float: left; text-align: left; font-size: 16px; margin-top: 10px; margin-bottom: 10px;">
                                    @if($data['appointment_data']['send_to']=="customer")
                                        ...
                                        @if($data['appointment_data']['status'] == "confirmed")
                                            ...
                                            have been Received and  Confirmed By the Boat Owner.We wish you have and amazing time on the boat!
                                        @elseif($data['appointment_data']['status'] == "cancelled")
                                            Your Booking Request For,
                                            <strong>
                                                {{ $data['appointment_data']['appointment_freelancer']['first_name'] }}
                                                {{ empty($data['appointment_data']['appointment_freelancer']['last_name']) ? ' ' : ' - '.$data['appointment_data']['appointment_freelancer']['last_name'] }}
                                            </strong>
                                            have been Reviewed and Cancelled  By the Boat Owner.Please View the other boat options and Book a new Boat.
                                        @endif
                                    @elseif($data['appointment_data']['send_to']=="freelancer")
...
{{--                                            <img src="http://d2bp2kgc0vgu09.cloudfront.net/uploads/general/{{$calender_image}}" style="border: none; float: left; width: 21px; margin-right: 5px; margin-top: 3px">--}}
                                            <span style="float: left; margin-top: 1px;">My Bookings</span>
...
{{--                                            <img src="http://d2bp2kgc0vgu09.cloudfront.net/uploads/general/{{$calender_image}}" style="border: none; float: left; width: 21px; margin-right: 5px; margin-top: 3px">--}}
                                            <span style="float: left; margin-top: 1px;">Book Now</span>
                                        </a>
                                        @else
                                        <a href="{{$url}}" style="background-color: #43DCBB;color: #ffffff;font-size: 18px;text-align: center;display: inline-block;border-radius: 37px;text-decoration: none;padding-top: 10px;padding-bottom: 10px;padding-left: 45px;padding-right: 45px;margin: auto;">
